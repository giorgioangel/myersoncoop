...
def rollout(sim_number, coalition_policy, coalition_stats=None):
...
def hybrid_monte_carlo_meyerson(sim_number, meyerson_M, exact_computations, player_stats=None):
    if not player_stats:
